...
reporting `__version__ == "0.1.0"`, and the reason `__version__` here is read
from installed metadata rather than restated.
"""
...
# have caught it ran after the version was already burned.
#
...
SERVER_DETAIL = SCHEMA["definitions"]["ServerDetail"]["properties"]
DESCRIPTION_MAX = SERVER_DETAIL["description"]["maxLength"]
